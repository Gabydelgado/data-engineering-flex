...
def send_email(crypto, value_usd, email):
    try:
        ...
        subject = f'Alerta de crypto {crypto}'
        body = f'La crypto {crypto} llego al valor de {value_usd} dólares'
        
        # Usar MIMEMultipart para manejar la codificación
        msg = MIMEMultipart()
        msg['From'] = email
        msg['To'] = email
        msg['Subject'] = subject
